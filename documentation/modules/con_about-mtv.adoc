...
These two types of migration are discussed in detail in xref:con_about-cold-warm-migration_mtv[About cold and warm migration].
...
For more information about live migration, see link:{mtv-plan}assembly_live-migration_mtv[Live migration in {project-short}].
