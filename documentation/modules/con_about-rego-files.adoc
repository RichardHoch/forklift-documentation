...
[id="con_about-rego-files_{context}"]
= About Rego files
...
* link:https://www.openpolicyagent.org/docs/latest/policy-language/[Policy Language]
* link:https://github.com/kubev2v/forklift/tree/main/validation#opa-rules-files[OPA Rules Files]
* link:https://github.com/kubev2v/forklift/tree/main/validation/policies/io/konveyor/forklift/vmware[VMware .rego files]
