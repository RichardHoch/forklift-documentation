...
With this enhancement, visible validation checks for warm migrations from {vmw} environments are available in the web console. You receive an alert if the {vmw} vSphere Virtual Disk Development Kit (VDDK) is missing or incorrectly configured.
+
