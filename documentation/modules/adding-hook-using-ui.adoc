...
.. Optional: Enter the *Service account* name. The service account must have the necessary RBAC permissions to manage cluster resources and at least write access for the +{namespace}+ namespace where hooks execute.
