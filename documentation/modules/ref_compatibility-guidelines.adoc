...
[id="ref_compatibility-guidelines_{context}"]
= Software compatibility guidelines

[role="_abstract"]
You must install compatible software versions. The table that follows lists the relevant software versions for this version of {project-first}.
...
{project-short} was tested only with {rhv-full} 4.4 SP1.
...
Generally it is advised to upgrade {rhv-full} Manager to the previously mentioned supported version before the migration to {virt}.
